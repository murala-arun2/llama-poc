...
python_binding = get_binding('java')  # this is a pycapsule object pointing to the C binding
python_lang = get_language('java')  # this is an instance of tree_sitter.Language
parser = get_parser('java')  # this is an instance of tree_sitter.Parser
