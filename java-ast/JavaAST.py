...
class JavaASTListener(JavaParserListener):
    ...
    def enterGenericInterfaceMethodDeclaration(self, ctx):
        print('ctx generic interface method text: ', ctx.getText())
    ...
    def enterInterfaceMethodDeclaration(self, ctx):
        print('ctx interface method text: ', ctx.getText())
        method_name = ctx.interfaceCommonBodyDeclaration().identifier().getText()
        return_type = ctx.interfaceCommonBodyDeclaration().typeTypeOrVoid().getText()
    ...
    def enterMemberReferenceExpression(self, ctx):
        print('ctx member reference expression text: ', ctx.getText(), re.split(r'(\(|\))',ctx.getText()))
    ...
    def enterClassCreatorRest(self, ctx):
        print('enterClassCreatorRest :', ctx.getText())

    def enterCreatedName(self, ctx):
        print('enterCreatedName :', ctx.getText())

    def enterCreator(self, ctx):
        print('enterCreator :', ctx.getText())

    def enterExpressionLambda(self, ctx):
        print('enterExpressionLambda :', ctx.getText())

    def enterInnerCreator(self, ctx):
        print('enterInnerCreator :', ctx.getText())
